...
n = 150;  % Phase intervals
n2 = 50; % Torque intervals
n3 = 125; % Velocity intervals
tdot_max = 2500;
...
for k = 1:n3
    ...
    i_max_vec(k) = max(i_mag_max, i_mag_min);   
    toc
    k
end


figure;plot(tdot, t_max_vec, tdot, t_min_vec); title('Max/Min Torque')
